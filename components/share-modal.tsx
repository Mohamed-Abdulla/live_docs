...
export const ShareModal: FC<ShareDocumentDialogProps> = ({ collaborators, creatorId, currentUserType, roomId }) => {
  const [open, setOpen] = useState(false);
  const [loading, setLoading] = useState(false);

  const user = useSelf(); // This is the current user who do change
